...
Release:    	1%{?dist}
License:    	GPLv3.0
Requires:   	%{?el6:daemontools} %{?el7:psmisc} %{?el8:psmisc} libcap openssh-clients iproute %{?el7:sysvinit-tools} %{?el8:procps-ng} %{?el9:procps-ng} %{?el10:procps-ng} net-tools hostname /bin/sh bash
